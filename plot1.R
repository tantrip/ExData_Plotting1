...
png(filename="C:/dev/data/coursera/ExData_Plotting1/plot1.png", height=480, width=480, bg="transparent")

# Plot the histogram to replicate what was asked in the assignment and save it
hist(dt$Global_active_power, main="Global Active Power", col="Red", xlab = "Global Active Power (kilowatts)", ylab = "Frequency") #plot 1
